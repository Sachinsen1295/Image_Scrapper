...
def fetch_image_urls(query: str, max_links_to_fetch: int, wd: webdriver, sleep_between_interactions: int = 1):
    ...
    while image_count < max_links_to_fetch:
        ...
        #thumbnail_results=list(thumbnail_results)
        print(thumbnail_results)
        print("here is a thumbnail")
...
DRIVER_PATH = r'/Users/sachinsen/Documents/ineuron/projects/Image_Scrapper/chromedriver.exe'
search_term = 'trump'
